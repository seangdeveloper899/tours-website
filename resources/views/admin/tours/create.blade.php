...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.tours.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="4" 
                              class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" required>{{ old('description') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="included_items" rows="4" 
                              class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
                              placeholder="Professional guide&#10;Hotel pickup and drop-off&#10;Entrance fees">{{ old('included_items') }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="excluded_items" rows="4" 
                              class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
                              placeholder="Personal expenses&#10;Travel insurance&#10;Meals not mentioned">{{ old('excluded_items') }}</textarea>
                    <p class="text-sm text-gray-500 mt-1">Enter each item on a new line</p>
                </div>
